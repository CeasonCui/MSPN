...
class SELFDataset(JointsDataset):
    ...
    def __init__(self, DATASET, stage, transform=None):
        ...
        #self._exception_ids = ['366379']#要加吗
        ...
        if self.stage == 'train':
            for aid, ann in coco.anns.items():
                ...
                if img_id not in coco.imgs: #\
                        #or img_id in self._exception_ids: #疑问
                    continue
                ...
                prefix = 'val' if 'val' in img_name else 'train'
                ...
                center[0] = coco.imgs[img_id]['width']/2.0
                center[1] = coco.imgs[img_id]['height']/2.0
                scale[0] = coco.imgs[img_id]['width']
                scale[1] = coco.imgs[img_id]['height']
            ...
            #         continue
                ...
                img_path = os.path.join(self.cur_dir, 'images', 'val',
                        img_name)
    ...
    def visualize(self, img, joints, score=None): #画线用的
        ...
        # for pair in pairs:
        #     draw_line(img, int(joints[pair[0] - 1]), int(joints[pair[1] - 1]))
...
if __name__ == '__main__':
    ...
    dataset = load_dataset('SELF')
    self_data = SELFDataset(dataset, 'val')
    print(self_data.data_num)
